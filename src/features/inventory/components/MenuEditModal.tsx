...
export const MenuEditModal = ({ initialValues, onSubmit, onClose }: MenuEditModalProps) => {
  ...
  const [vegetarianDishName, setVegetarianDishName] = useState(initialValues.vegetarianDishName ?? "");
